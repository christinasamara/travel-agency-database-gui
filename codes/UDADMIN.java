...
public class UDADMIN extends javax.swing.JFrame {

    /**
     * Creates new form UDADMIN
     */
    public UDADMIN() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        amanages = new javax.swing.JTextField();
        ...
        jLabel11.setText("admin manages branch");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(amanages, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(75, 75, 75)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel11)
                            .addComponent(amanages, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(95, 95, 95))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jview)
                        .addGap(18, 18, 18)
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        String at = tb1.getValueAt(jTable2.getSelectedRow(), 0).toString();
        String name = tb1.getValueAt(jTable2.getSelectedRow(), 1).toString();
        String lname = tb1.getValueAt(jTable2.getSelectedRow(), 2).toString();
        String salary = tb1.getValueAt(jTable2.getSelectedRow(), 3).toString();
        String branch = tb1.getValueAt(jTable2.getSelectedRow(), 4).toString();
        String type = tb1.getValueAt(jTable2.getSelectedRow(), 5).toString();
        String diploma = tb1.getValueAt(jTable2.getSelectedRow(), 6).toString();
        String dmanages = tb1.getValueAt(jTable2.getSelectedRow(), 7).toString();
        ...
        atype.setText(type);
        adiploma.setText(diploma);
        amanages.setText(dmanages);
    ...
    private void jviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jviewActionPerformed
        ...
        try {
            ...
            String sql = "SELECT * FROM worker JOIN admin ON wrk_AT = adm_AT JOIN manages ON mng_adm_AT = adm_AT ";
            ...
            while (myRs.next()) {
                ...
                String adm_type = String.valueOf(myRs.getString("adm_type"));
                String adm_diploma = String.valueOf(myRs.getString("adm_diploma"));
                String adm_mng = String.valueOf(myRs.getString("mng_br_code"));

                String tbData[] = {wrk_AT, wrk_name, wrk_lname, wrk_salary, wrk_br_code, adm_type, adm_diploma, adm_mng };
    ...
    private void jupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jupdateActionPerformed
        ...
        try {
            ...
            if (jTable2.getSelectedRowCount() == 1) {
                ...
                String utype = atype.getText();
                String udiploma = adiploma.getText();
                String umanages = amanages.getText();

                myConn = DriverManager.getConnection("jdbc:mysql://localhost:3306/travel_agency", user, pass);

                String sql = "UPDATE admin JOIN worker ON wrk_AT = adm_AT LEFT JOIN manages ON mng_adm_AT = adm_AT SET wrk_name='" + uname + "', wrk_lname='" + ulname + "', wrk_salary='" + usalary + "', wrk_br_code='" + ubranch + "', adm_type='" + utype + "', adm_diploma='" + udiploma + "', mng_br_code='" + umanages + "'WHERE adm_AT='" + uat + "';";
    ...
    private void jdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jdeleteActionPerformed
        ...
        try {
            ...
            if (jTable2.getSelectedRowCount() == 1) {
                ...
                if (jTable2.getRowCount() == 0) {
                    JOptionPane.showMessageDialog(this, "Cannot perform an deletion with no records.");
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UDADMIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField amanages;
