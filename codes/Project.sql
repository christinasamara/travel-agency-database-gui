...
of_br_code INT NOT NULL,

primary key(of_id),
CONSTRAINT OFDST FOREIGN KEY (of_dst_id) REFERENCES destination(dst_id)
ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT OFBR FOREIGN KEY(of_br_code) REFERENCES branch(br_code)
ON DELETE CASCADE ON UPDATE CASCADE
);
...
(1, "2023-05-01", "2025-05-01", 500, 5, 1),
(2, "2023-10-10", "2026-05-05", 700, 4, 2),
(3, "2023-03-10", "2024-04-06", 450, 10, 3);
...
LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\names.csv' INTO TABLE reservation_offers
    ...
    SET resof_of_id = 1, 
    resof_paid = FLOOR(RAND() * (200 - 50 + 1) + 50);
